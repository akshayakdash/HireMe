    ...
    public class CandidatesController : ApiController
    {
        ...
        public HttpResponseMessage CreateJobRequest([FromUri]int candidateId, [FromBody] CandidateProfileViewModel candidateProfile)
        {
            ...
            if (!string.IsNullOrWhiteSpace(candidateProfile.JobRequestSkillPic1Base64))
            {
                ...
                string fileName = DateTime.Now.Ticks.ToString() + ".jpg";//+ Base64Extensions.GetFileExtension(candidateProfile.JobRequestSkillPic1Base64);
            ...
            if (!string.IsNullOrWhiteSpace(candidateProfile.JobRequestSkillPic2Base64))
            {
                ...
                string fileName = DateTime.Now.Ticks.ToString() + ".jpg";// + Base64Extensions.GetFileExtension(candidateProfile.JobRequestSkillPic2Base64);
            ...
            if (!string.IsNullOrWhiteSpace(candidateProfile.JobRequestSkillPic3Base64))
            {
                ...
                string fileName = DateTime.Now.Ticks.ToString() + ".jpg";//+ Base64Extensions.GetFileExtension(candidateProfile.JobRequestSkillPic3Base64);
